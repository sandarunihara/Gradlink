...
<body>
        ...
        <main class="main-content">
            ...
            <header class="dashboard-header">
                <div class="header-left">
                    ...
                    <div class="breadcrumbs">Placement Dashboard / Overview</div>
                </div>
                <div class="header-right">
                    <div class="date-time-card">
                        <span class="current-round">Round <?= $cards['round'] ?></span>
                        <div class="datetime">
                            <span id="date"></span>
                            <span id="time"></span>
                        </div>
            ...
            <div class="data-section">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="company-cell">
                                                    <img src="data:image/jpeg;base64,<?= $advertisement['profileimg'] ?? '' ?>" alt="<?= $advertisement['companyName'] ?>" onerror="this.src='<?= ROOT ?>/assets/images/default-company.png'">
                ...
                <div class="sidebar-cards">
                            ...
                            <?php if (!empty($company)): ?>
                                <?php foreach($company as $comp): ?>
                                    <div class="company-item">
                                        <img src="data:image/jpeg;base64,<?= $comp['profileimg'] ?>" alt="<?= $comp['Name'] ?>" onerror="this.src='<?= ROOT ?>/assets/images/default-company.png'">
                    ...
                    <div class="sidebar-card top-students">
                        <div class="card-header">
                            <h3>Top Performing Students</h3>
                            <a href="<?= ROOT ?>/PDC_admin/students" class="view-all">View All</a>
                        </div>
                        <div class="students-list">
                            <div class="student-item">
                                <div class="student-rank">1</div>
                                <img src="<?= ROOT ?>/assets/images/default-student.png" alt="Student">
                                <div class="student-info">
                                    <h4>Alex Johnson</h4>
                                    <p>Computer Science</p>
                                </div>
                                <div class="student-gpa">3.98</div>
                            </div>
                            <div class="student-item">
                                ...
                                <div class="student-gpa">3.95</div>
                            </div>
                            <div class="student-item">
                                ...
                                <div class="student-gpa">3.92</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        // Placement Trend Chart (ApexCharts)
