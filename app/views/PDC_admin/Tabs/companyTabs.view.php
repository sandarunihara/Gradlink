<div class="tabs">
    ...
    <button class="tab-button  <?= $activeTab == 'Blocked-companies' ? 'active' : '' ?>" onclick="window.location.href='/Gradlink/public/PDC_admin/BlockCompany/dashboard'" >Blocked Companies</button>
</div>