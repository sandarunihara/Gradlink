<div class="tabs">
    ...
    <button class="tab-button  <?= $activeTab == 'working-list' ? 'active' : '' ?>" onclick="window.location.href='/Gradlink/public/PDC_coordinator/workingStudents'" >Working Students</button>
</div>